...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_UnityStore_2.25.0-27503_x64_android64_arm64_android_ios64_macosx_vs2019_ios_android_linux.zip "%OPEN_SOURCE_UNITY_REPO_PATH%ExternalLibs.zip"
