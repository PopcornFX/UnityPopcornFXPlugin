...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_UnityStore_2.20.13-26695_arm64_x64_ios64_android_x32_android64_macosx_ios_vs2019_linux_android.zip "%OPEN_SOURCE_UNITY_REPO_PATH%ExternalLibs.zip"
