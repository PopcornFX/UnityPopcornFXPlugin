...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_UnityStore_2.23.0-25090_android_arm64_android64_ios64_x64_ios_vs2019_linux_macosx_android.zip "%OPEN_SOURCE_UNITY_REPO_PATH%ExternalLibs.zip"
