...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_UnityStore_2.20.12-25299_ios64_android64_x64_android_x32_arm64_macosx_vs2019_android_linux_ios.zip "%OPEN_SOURCE_UNITY_REPO_PATH%ExternalLibs.zip"
