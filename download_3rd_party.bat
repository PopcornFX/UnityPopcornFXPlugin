...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_UnityStore_2.23.5-26726_x64_arm64_android64_android_ios64_vs2019_linux_android_macosx_ios.zip "%OPEN_SOURCE_UNITY_REPO_PATH%ExternalLibs.zip"
