...
ifeq ($(config),debug_x32)
  PK_Runtime_config = debug_x32
  PK_Discretizers_config = debug_x32
  PK_ParticlesToolbox_config = debug_x32
  PK_Plugin_CompilerBackend_CPU_VM_config = debug_x32
  PK_Plugin_CodecImage_DDS_config = debug_x32
  PK_Plugin_CodecImage_JPG_config = debug_x32
  PK_Plugin_CodecImage_PNG_config = debug_x32
  PK_Plugin_CodecImage_TGA_config = debug_x32
  PK_Plugin_CodecImage_TIFF_config = debug_x32
  PK_Plugin_CodecImage_PKM_config = debug_x32
  PK_Plugin_CodecImage_PVR_config = debug_x32
  PK_Plugin_CodecImage_HDR_config = debug_x32
  PK_Plugin_CodecImage_EXR_config = debug_x32
  PK_Plugin_CodecMesh_FBX_config = debug_x32
  ...
  PK_Sample_02_BasicEvolve_config = debug_x32
  PK_Sample_03_EngineHooks_config = debug_x32
  PK_Sample_04_Baking_config = debug_x32
  PK_Sample_05_Upgrader_config = debug_x32
  PK_RenderHelpers_config = debug_x32
  PK_RHI_config = debug_x32
  PK_SampleLib_config = debug_x32
  PK_ShaderTool_config = debug_x32
  PK_MCPP_config = debug_x32
  PK_Sample_01_BasicRendering_config = debug_x32
  PK_Sample_02_FullIntegration_config = debug_x32
  PK_Sample_04_EffectInterface_config = debug_x32
  PK_Sample_05_Stats_config = debug_x32
  PK_Sample_06_SimInterface_config = debug_x32
  PK_Sample_06_SimInterfaceGPU_config = debug_x32
  PK_Sample_07_LOD_config = debug_x32
  PK_Sample_08_CustomCollision_config = debug_x32
  PK_Sample_09_AsyncLoading_config = debug_x32
  PK_Sample_10_AsyncRendering_config = debug_x32
  PK_Sample_11_ThreadPool_config = debug_x32
  PK_Sample_12_GBufferSampling_config = debug_x32
  ...
  PK_Runtime_config = release_x32
  PK_Discretizers_config = release_x32
  PK_ParticlesToolbox_config = release_x32
  PK_Plugin_CompilerBackend_CPU_VM_config = release_x32
  PK_Plugin_CodecImage_DDS_config = release_x32
  PK_Plugin_CodecImage_JPG_config = release_x32
  PK_Plugin_CodecImage_PNG_config = release_x32
  PK_Plugin_CodecImage_TGA_config = release_x32
  PK_Plugin_CodecImage_TIFF_config = release_x32
  PK_Plugin_CodecImage_PKM_config = release_x32
  PK_Plugin_CodecImage_PVR_config = release_x32
  PK_Plugin_CodecImage_HDR_config = release_x32
  PK_Plugin_CodecImage_EXR_config = release_x32
  PK_Plugin_CodecMesh_FBX_config = release_x32
  ...
  PK_Sample_02_BasicEvolve_config = release_x32
  PK_Sample_03_EngineHooks_config = release_x32
  PK_Sample_04_Baking_config = release_x32
  PK_Sample_05_Upgrader_config = release_x32
  PK_RenderHelpers_config = release_x32
  PK_RHI_config = release_x32
  PK_SampleLib_config = release_x32
  PK_ShaderTool_config = release_x32
  PK_MCPP_config = release_x32
  PK_Sample_01_BasicRendering_config = release_x32
  PK_Sample_02_FullIntegration_config = release_x32
  PK_Sample_04_EffectInterface_config = release_x32
  PK_Sample_05_Stats_config = release_x32
  PK_Sample_06_SimInterface_config = release_x32
  PK_Sample_06_SimInterfaceGPU_config = release_x32
  PK_Sample_07_LOD_config = release_x32
  PK_Sample_08_CustomCollision_config = release_x32
  PK_Sample_09_AsyncLoading_config = release_x32
  PK_Sample_10_AsyncRendering_config = release_x32
  PK_Sample_11_ThreadPool_config = release_x32
  PK_Sample_12_GBufferSampling_config = release_x32
  ...
  PK_Runtime_config = retail_x32
  PK_Discretizers_config = retail_x32
  PK_ParticlesToolbox_config = retail_x32
  PK_Plugin_CompilerBackend_CPU_VM_config = retail_x32
  PK_Plugin_CodecImage_DDS_config = retail_x32
  PK_Plugin_CodecImage_JPG_config = retail_x32
  PK_Plugin_CodecImage_PNG_config = retail_x32
  PK_Plugin_CodecImage_TGA_config = retail_x32
  PK_Plugin_CodecImage_TIFF_config = retail_x32
  PK_Plugin_CodecImage_PKM_config = retail_x32
  PK_Plugin_CodecImage_PVR_config = retail_x32
  PK_Plugin_CodecImage_HDR_config = retail_x32
  PK_Plugin_CodecImage_EXR_config = retail_x32
  ...
  PK_Sample_02_BasicEvolve_config = retail_x32
  PK_Sample_03_EngineHooks_config = retail_x32
  PK_Sample_04_Baking_config = retail_x32
  PK_Sample_05_Upgrader_config = retail_x32
  PK_RenderHelpers_config = retail_x32
  PK_RHI_config = retail_x32
  PK_SampleLib_config = retail_x32
  PK_MCPP_config = retail_x32
  PK_Sample_01_BasicRendering_config = retail_x32
  PK_Sample_02_FullIntegration_config = retail_x32
  PK_Sample_04_EffectInterface_config = retail_x32
  PK_Sample_05_Stats_config = retail_x32
  PK_Sample_06_SimInterface_config = retail_x32
  PK_Sample_06_SimInterfaceGPU_config = retail_x32
  PK_Sample_07_LOD_config = retail_x32
  PK_Sample_08_CustomCollision_config = retail_x32
  PK_Sample_09_AsyncLoading_config = retail_x32
  PK_Sample_10_AsyncRendering_config = retail_x32
  PK_Sample_11_ThreadPool_config = retail_x32
  PK_Sample_12_GBufferSampling_config = retail_x32
...
PK-Sample_07_LOD: PK-SampleLib PK-RHI PK-RenderHelpers PK-MCPP PK-Plugin_CompilerBackend_CPU_VM PK-Plugin_CodecImage_DDS PK-Plugin_CodecImage_JPG PK-Plugin_CodecImage_PKM PK-Plugin_CodecImage_PNG PK-Plugin_CodecImage_PVR PK-Plugin_CodecImage_TGA PK-Discretizers PK-ParticlesToolbox PK-Runtime PK-ZLib
