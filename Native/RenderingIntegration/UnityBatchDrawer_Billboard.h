...
class	CUnityBatchDrawer_Billboard : public PopcornFX::CRendererBatchJobs_Billboard_CPUBB
{
public:
	CUnityBatchDrawer_Billboard();
	~CUnityBatchDrawer_Billboard();
...
private:
	...
	bool				_RenderThread_SetupBuffersBillboards(const SGeneratedInputs &toMap);
