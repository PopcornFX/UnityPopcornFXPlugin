...
class	CUnityBatchDrawer_Sound : public PopcornFX::CRendererBatchJobs_Sound_Std
{
public:
	CUnityBatchDrawer_Sound();
	~CUnityBatchDrawer_Sound();
...
private:
	...
	bool				_UpdateThread_IssueDrawCallSound(const Drawers::SSound_DrawRequest *soundRequest, CUnityRendererCache *rdrCache, u32 &particleCount);
