...
Shader "PopcornFX/HDRP/PKFxParticleProceduralShader"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile_local _ PK_HAS_DISTORTION
			//------------------------------------------------------------------------------------
			...
			// Particle shader
			//------------------------------------------------------------------------------------
			#include "Packages/com.persistant-studios.popcornfx/Runtime/Materials/PKFxShaderCode/ParticleProceduralShader.inc"
