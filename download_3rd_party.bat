...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_UnityStore_2.25.1-27703_ios64_x64_android_arm64_android64_macosx_android_ios_vs2019_linux.zip "%OPEN_SOURCE_UNITY_REPO_PATH%ExternalLibs.zip"
