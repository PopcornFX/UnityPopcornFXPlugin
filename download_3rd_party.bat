...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_UnityStore_2.24.4-27072_android64_arm64_ios64_x64_android_android_macosx_linux_vs2019_ios.zip "%OPEN_SOURCE_UNITY_REPO_PATH%ExternalLibs.zip"
