...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_UnityStore_2.24.5-27590_x64_android_ios64_arm64_android64_vs2019_android_ios_macosx_linux.zip "%OPEN_SOURCE_UNITY_REPO_PATH%ExternalLibs.zip"
