...
class	CUnityBatchDrawer_Triangle : public PopcornFX::CRendererBatchJobs_Triangle_CPUBB
{
public:
	CUnityBatchDrawer_Triangle();
	~CUnityBatchDrawer_Triangle();
...
private:
	...
	bool				_RenderThread_SetupBuffersTriangles(const SGeneratedInputs &toMap);
