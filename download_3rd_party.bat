...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/SDK/b32d93a3/ExternalLibs_CommunityLicense_Unity_2.13.2-14156_android_android64_x64_android_linux_macosx_vs2019.zip "%OPEN_SOURCE_UNITY_REPO_PATH%ExternalLibs.zip"
