...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/SDK/b32d93a3/ExternalLibs_CommunityLicense_Unity_2.15.8-17129_android_android64_ios_ios64_x64_android_ios_linux_macosx_vs2019.zip "%OPEN_SOURCE_UNITY_REPO_PATH%ExternalLibs.zip"
